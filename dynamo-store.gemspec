...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Rails Cache Store for DynamoDb}
  spec.description   = %q{Rails Cache Store for DynamoDb}
  ...
  # spec.add_development_dependency "dynamo-store", git: "https://github.com/GetTerminus/dynamo-store.git"
end
